...
/************************* WRITE HANDLE *************************/
/**
 * handle_write_char - to print a string
 * @c: char types.
...
/************************* WRITE NUMBER *************************/
/**
 * write_number - to print a string
 ...
 * @ind: Index in which the number starts on the buffer
 * @buffer: Buffer
 * @flags: Flags
 * @width: width
...
/**
 * write_unsgnd - to write an unsigned number
